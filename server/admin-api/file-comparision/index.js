        ...
        if (matchedClient.file) {
          ...
          if (userFile && clientFile) {
            ...
            userWorkBook.SheetNames.forEach(function(sheetName) {
              ...
              console.log("userRowObject", _.size(userRowObject));
            });
            clientWorkBook.SheetNames.forEach(function(sheetName) {
              ...
              console.log("clientRowObject", clientRowObject);
            });
            if (_.size(userRowObject) && _.size(clientRowObject)) {
              ...
              res.send({ userRowObject: userRowObject, clientRowObject: clientRowObject, status: '204', message: 'Empty file' });
            }
          }
        } else if (err) {
          res.send(err);
